...
export function WhatsAppButton() {
  ...
  const { data } = useSetting<WhatsAppSetting>("whatsapp");
  ...
  return (
    <a
      ...
      aria-label="Falar com a NUVE no WhatsApp"
      className="group fixed bottom-4 right-4 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-white shadow-lg transition-transform hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink sm:bottom-6 sm:right-6"
    >
